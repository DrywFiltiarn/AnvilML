...
All fifteen are closed in the current task graph as of this document's generation. Items 1–10 are retrofit tasks in Phase 900 (completed phases P1/P3/P6 cannot be edited directly per project convention — fixes for defects in completed phases always land in P900). Items 11–15 are in-phase corrections to Phase 8, Phase 18, and Phase 17 respectively, since none of those phases had executed yet when found — the fix lands in the phase that owns the gap rather than in a retrofit.
