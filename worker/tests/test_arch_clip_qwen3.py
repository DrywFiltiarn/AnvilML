...
def test_load_mock_no_torch_import() -> None:
    ...
    Tests:
        ...
        module from cache, and re-import the ``qwen3`` module. Assert
    ...
    sys.modules.pop("worker.nodes.arch.clip.qwen3", None)
    ...
    try:
        ...
        assert callable(qwen3_mod.can_handle)
        assert callable(qwen3_mod.load)
    finally:
